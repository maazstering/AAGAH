...
import 'package:app/screens/home/feed.dart';
import 'package:app/screens/home/settingsPage.dart';
import 'package:app/service/profile_repository.dart';
import 'package:app/widgets/bottomNavigationCard.dart';
import 'package:flutter/material.dart';
import 'package:image_picker/image_picker.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
...
import '../../widgets/savedRoutesButton.dart';
import 'package:app/widgets/variables.dart';
import 'package:app/service/user_repository.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Future<void> fetchProfile() async {
    ...
    if (token != null) {
      try {
        final response = await profileRepository.getCurrentUser(token);
        setState(() {
  ...
  Future<void> updateProfile() async {
    ...
    if (token != null) {
      try {
        final response = await profileRepository.updateSelfProfile(
          token,
          nameController.text,
          age ?? 0,
          email,
